...
class AuthController extends Controller
{
  ...
  function register(Request $data)
  {
    ...
    try{
      ...
      $user->api_token = 'eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzI1NiJ9.eyJzdWJqZWN0IjoyLCJjcmVhdGlvbl90aW1lIjoxNTc5MTIxNDE2LCJleHBpcmF0aW9uX3RpbWUiOjE1NzkxMjUwMTZ9.bQs_8AckJQ0f2PgoZNI8ogPetyzsy4CugNIiTT3gN-w';
      $user->save();
      $message = "Tu nueva contraseña es " . $new_password;
